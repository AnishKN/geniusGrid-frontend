    ...
    <div className="flex flex-col lg:flex-row">
      ...
      <div className="w-full bg-white lg:h-screen flex items-center justify-center">
        <div className="lg:p-12 md:p-8 sm:p-6 p-4 lg:w-7/12">
          <div className="mb-4">
            <label htmlFor="shortTermGoals" className="block text-gray-700">
              Short Term Goals
            </label>
            <select
              id="shortTermGoals"
            ...
            >
              ...
              <option value="Practice problem-solving">
                Practice problem-solving
              </option>
              <option value="Participate in study group">
                Participate in study group
              </option>
              <option value="Revise class presentations">
                Revise class presentations
              </option>
              <option value="Attend academic workshop">
                Attend academic workshop
              </option>
            </select>
          </div>
          <div className="mb-4">
            <label htmlFor="longTermGoals" className="block text-gray-700">
              Long Term Goals
            </label>
            <select
              id="longTermGoals"
            ...
            >
              ...
              <option value="Secure Internship Placement">
                Secure Internship Placement
              </option>
              <option value="Publish Research Paper">
                Publish Research Paper
              </option>
              <option value="Participate in Study Abroad Program">
                Participate in Study Abroad Program
              </option>
              <option value="Apply to Graduate School">
                Apply to Graduate School
              </option>
              <option value="Build Professional Network">
                Build Professional Network
              </option>
              <option value="Develop Leadership Skills">
                Develop Leadership Skills
              </option>
              <option value="Explore Career Opportunities">
                Explore Career Opportunities
              </option>
              <option value="Pursue Doctoral Studies">
          ...
          <div className="mb-4">
            <label htmlFor="preferredStudyTimes" className="block text-gray-700">
